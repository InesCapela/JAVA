...
/**
 * The java.nio.file package provides extensive support for file and file system I/O.
 *
 * New classes for the job:
 * 1. Path class has methods for manipulating a path (Paths class may be used to get a Path).
 * 2. Files class has methods for file operations, e.g. moving, copy, deleting, see/change attributes, etc.).
 * 3. FileSystem class has a variety of methods for obtaining information about the file system.
 *
 */
public class FilePropertiesApp {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            */
            ...
            System.out.println("File is hidden? – " + file.canRead());
            ...
            Path pathToFile = file.toPath(); //path adapta-se ao SO, ao contrario do file
    ...
    //imprimir ficheiro pastas e subpastas do folder
    private static void printRecursiveFolderContent(Path pathToDir, String tabs) {
        System.out.println(tabs+pathToDir.getFileName());//print nome da pasta
